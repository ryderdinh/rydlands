...
const controls: readonly TunerControl[] = [
	...
	{ key: 'speed', label: 'ROTATION_SPEED', min: -2, max: 2, step: 0.01 },
	{ key: 'hoverSlow', label: 'hover speed (× of speed)', min: 0, max: 1, step: 0.05 },
	...
	{ key: 'hoverGlow', label: 'hover glow', min: 0, max: 1.2, step: 0.05 },
...
const colors: readonly TunerColor[] = [
	...
	{ key: 'hoverGlowColor', label: 'hover glow color' }
]
